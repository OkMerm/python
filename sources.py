...
class Probe:
    ...
    H = TypeVar("H", bound=np.generic, covariant=True)
    def addData(self, E: npt.NDArray[E], H: npt.NDArray[H]):
        '''
...
class AnimateFieldDisplay:
    ...
    def updateData(self, data: npt.NDArray[T], timeCount: int):
        '''
...
class Source1D(metaclass=ABCMeta):
    ...
    @abstractmethod
    def getFieldE(self, position, time, q,):
        '''
